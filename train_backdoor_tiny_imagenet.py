...
parser.add_argument('--model', default='resnet50', choices=['resnet18', 'resnet50', 'resnet34'])
...
parser.add_argument('--output_dir', type=str, default='save_metric_tiny_select', help='directory where to save metrics, same with the one used in cal_metric.py')
parser.add_argument('--result_dir', type=str, default='save_attack', help='directory where to save results')
parser.add_argument('--data_dir', type=str, default='/home/boot/STU/DATASETS/tiny', help='directory where is dataset')
...
if args.selection in ['loss', 'grad', 'forget']:
    ...
    for i in shuffle:
        if train_dataset[i][1] == args.y_target and k < total_poison:
            ...
            k += 1
#traindataset = transform_dataset(train_dataset)
...
#poison_train_set = MyTinyDataset(poison_train_set, train_transform)
train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=4)
test_loader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=True, num_workers=4)
trigger_loader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=True, num_workers=4)
num_classes = 78
